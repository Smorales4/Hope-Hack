...
function getResults() {
  ...
  // Declared variable that determines where we'll be pulling our 3rd party data from, as well as necesary parameters of pulled data
  const options = {
    method: "GET",
...
// Function that will return book data from 3rd Party API as long as search information is passed as "true" or matches data within from API
function myFunction() {
  document.getElementById("txtSearch").required = true;
}
